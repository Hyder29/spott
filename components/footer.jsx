  ...
  return (
    <footer className="border-t border-gray-800/50 py-8 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-6 text-sm text-gray-400">
        Made with ❤️ Gulam Hyder
      </div>

      <div className="flex gap-4 items-center">
        <a
          href="https://linkedin.com/in/gulamhyder29"
          className="text-gray-400"
        >
          <Linkedin className="w-5 h-5" />
        </a>
        <a
          href="https://www.instagram.com/hyderr_29?igsh=b3o4YTlrZ2EwM3F3"
          className="text-gray-400"
        >
          <Instagram className="w-5 h-5" />
        </a>
        <a href="https://x.com/hyderr_29" className="text-gray-400">
